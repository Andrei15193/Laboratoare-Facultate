...
import aop1.controller.StudentController;
...
public class StudentFrame extends JFrame
{
    public StudentFrame(final StudentController controller)
    {
        ...
        Application.logger.log(Level.INFO, "StudentFrame.StudentFrame("
    ...
    {
        Application.logger.log(Level.INFO, "StudentFrame.initialize()");
    ...
    {
        Application.logger.log(Level.INFO, "StudentFrame.buildMenuBar()");
    ...
    private class LogInDialog extends JDialog
    {
        public LogInDialog()
        {
            ...
            Application.logger.log(Level.INFO,
                            "StudentFrame.LogInDialog.LogInDialog()");
            this.setResizable(false);
            this.setModal(true);
            this.buildForm();
            this.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        ...
        {
            Application.logger.log(Level.INFO,
                            "StudentFrame.LogInDialog.buildForm()");
        ...
        {
            Application.logger.log(Level.INFO,
                            "StudentFrame.LogInDialog.errorMessage(" + message
                                            + " :String)");
        ...
        {
            Application.logger.log(Level.INFO,
                            "StudentFrame.LogInDialog.confirmationMessage("
                                            + message + " :String)");
        ...
        {
            Application.logger.log(Level.INFO,
                            "StudentFrame.LogInDialog.buildSubmitButton()");
        ...
        {
            Application.logger.log(Level.INFO,
                            "StudentFrame.LogInDialog.buildLabels()");
        ...
        {
            Application.logger.log(Level.INFO,
                            "StudentFrame.LogInDialog.buildTextFields()");
            final JPanel panel = new JPanel(null);
