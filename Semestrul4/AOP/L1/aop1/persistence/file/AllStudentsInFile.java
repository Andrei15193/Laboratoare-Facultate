...
public class AllStudentsInFile implements AllStudents
{
    public AllStudentsInFile(final String fileName)
    {
        Application.logger.log(Level.INFO,
                        "AllStudentsInFile.AllStudentsInFile(" + fileName
                                        + " :String)");
    ...
    {
        Application.logger.log(Level.INFO, "AllStudentsInFile.with(" + name
                        + " :String)");
        boolean eof = false;
    ...
    {
        Application.logger.log(Level.INFO, "AllStudentsInFile.nowInclude("
                        + student + " :Student)");
