...
public class FirmStringifier
{
    ...
    public Firm destring(String string) throws FirmException
    {
        ...
        if (fields.length >= 2)
        {
            ...
            {
                throw new FirmException(
                                "The specified turnover is not a number! ");
            }
            return new Firm(fields[0], turnover);
        }
        else
            throw new FirmException("Insufficient arguments! ");
    }
}
