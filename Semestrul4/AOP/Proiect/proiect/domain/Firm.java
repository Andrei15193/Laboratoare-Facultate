...
public class Firm
{
    ...
    public Firm(String name, Integer turnover) throws FirmException
    {
        this.name = name;
    ...
    // Validates the calling instance. See the constructor constraints to know
    // when
    // this method throws an exception.
    public void validate() throws FirmException
    {
        String errors = this.validateName() + this.validateTurnover();
        if (errors.length() > 0)
            throw new FirmException(errors);
    }
    ...
    public boolean equals(Object object)
    {
        if (object instanceof Firm)
        {
            ...
            return this.name.equals(firm.name)
                            && this.turnover.equals(firm.turnover);
        }
        else
            return false;
    }
    ...
    @Override
    // Returns the string representation of the calling instance. In this case
    // it's
    ...
    public void setName(String name) throws FirmException
    {
        String errors;
        this.name = name;
    ...
    // constraints to know when this method throws an Exception.
    public void setTurnover(Integer turnover) throws FirmException
    {
        String errors;
        this.turnover = turnover;
    ...
    // Returns a string of errors after validating the calling instance's
    // turnover.
    // If no errors occur the return string is empty (it's length is 0).
