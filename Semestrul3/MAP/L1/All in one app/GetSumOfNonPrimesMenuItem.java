...
public class GetSumOfNonPrimesMenuItem extends MenuItem {
    // Creates a new GetFirstPrimeMenuItem instance.
    // Preconditions:
    //      controller: a Controller that is used for business logic.
    public GetSumOfNonPrimesMenuItem(Controller controller) {
        super("Get the sum of all non primes in an array");
        this.controller = controller;
    }

    @Override
    // Reads an array from the given input and prints to the given output the sum of all
    ...
    public void run(java.io.BufferedReader input, java.io.PrintStream output) throws java.io.IOException {
        output.println("The sum of all non prime numbers in the array is " + this.controller.getNonPrimesSum(readArray(input, output)));
    }
