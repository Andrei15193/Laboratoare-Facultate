...
public class GetSumOfPrimesMenuItem extends MenuItem {
    // Creates a new GetFirstPrimeMenuItem instance.
    // Preconditions:
    //      controller: a Controller that is used for business logic.
    public GetSumOfPrimesMenuItem(Controller controller) {
        super("Get the sum of all primes in an array");
    ...
    public void run(java.io.BufferedReader input, java.io.PrintStream output) throws java.io.IOException {
        output.println("The sum of all prime numbers in the array is " + this.controller.getPrimesSum(readArray(input, output)));
    }
