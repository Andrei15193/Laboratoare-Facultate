...
public class GetProductOfPrimesMenuItem extends MenuItem {
    // Creates a new GetFirstPrimeMenuItem instance.
    // Preconditions:
    //      controller: a Controller that is used for business logic.
    public GetProductOfPrimesMenuItem(Controller controller) {
        super("Get the product of all primes in an array");
        this.controller = controller;
    }

    @Override
    // Reads an array from the given input and prints to the output the product of all
    ...
    public void run(java.io.BufferedReader input, java.io.PrintStream output) throws java.io.IOException {
        output.println("The product of all prime numbers in the array is " + this.controller.getPrimesProduct(readArray(input, output)));
    }
